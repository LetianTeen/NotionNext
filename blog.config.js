...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Saintforence', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '树洞', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://saintforence.dpdns.org/', // 网站地址
